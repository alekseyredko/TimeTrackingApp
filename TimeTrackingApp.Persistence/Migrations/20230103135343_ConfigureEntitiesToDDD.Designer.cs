...
namespace TimeTrackingApp.Persistence.Migrations
{
    ...
    [Migration("20230103135343_ConfigureEntitiesToDDD")]
    partial class ConfigureEntitiesToDDD
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrackingEventTrackingEventType1", b =>
                {
                    b.Property<Guid>("_trackingEventTypesId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("_trackingEventsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("_trackingEventTypesId", "_trackingEventsId");

                    b.HasIndex("_trackingEventsId");

                    b.ToTable("TrackingEventTrackingEventType1");
                });
            ...
            modelBuilder.Entity("TrackingEventTrackingEventType1", b =>
                {
                    b.HasOne("TimeTrackingApp.Domain.Entities.TrackingEventType", null)
                        .WithMany()
                        .HasForeignKey("_trackingEventTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TimeTrackingApp.Domain.Entities.TrackingEvent", null)
                        .WithMany()
                        .HasForeignKey("_trackingEventsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
